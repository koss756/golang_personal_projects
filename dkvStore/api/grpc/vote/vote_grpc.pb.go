...
const (
	VoteService_RequestVote_FullMethodName = "/VoteService/RequestVote"
)
...
func _VoteService_RequestVote_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: VoteService_RequestVote_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(VoteServiceServer).RequestVote(ctx, req.(*RequestVoteMsg))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _VoteService_RequestVote_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "api/grpc/vote/vote.proto",
}
